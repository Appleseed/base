...
namespace Appleseed.Services.Base.Data.Queue.Impl
{
    ...
    /// </summary>
    public class BaseItemProcessingQueue : IBaseMessageQueue<BaseCollectionItem>
    {
        /// <summary>
        /// Gets the log.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GA.Data.BaseCollectionItemQueue"/> class.
        /// </summary>
        ...
        public BaseItemProcessingQueue(string incomingConnectionString, ILog logger, string incomingTableName = null, string incomingQueueName = null)
        {
            this.Log = logger;
            this.ConnectionString = incomingConnectionString;
            this.Client = new SqlConnection(incomingConnectionString); // TODO: need to abstract to into DI / IOC 
        ...
        public BaseCollectionItem Dequeue()
        {
            ...
            db.CollectionItems.Update((int)item.ItemID, item);
            return item;
        }
