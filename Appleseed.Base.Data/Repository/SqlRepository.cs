...
namespace Appleseed.Base.Data.Repository
{
    public class SqlRepository : ISqlRepository, IDisposable
    {
        ...
        public void Insert(BaseCollectionItem baseCollectionItem)
        {
            ...
            SqlClient.Open();
            var query = @"Insert into dbo.basecollectionitem (Id, Data, ItemProcessed, CreatedDate , AggregationType) values(@ItemId, @ItemData, @ItemProcessed, @CreatedDate , @AggregationType)";
            ...
            command.Parameters.Add("@ItemData", SqlDbType.VarBinary).Value = baseCollectionItem.Data.SerializeToByteArray();
            ...
            command.Parameters.Add("@AggregationType", SqlDbType.VarChar).Value = baseCollectionItem.AggregationType;
        ...
        public void Update(BaseCollectionItem baseCollectionItem)
        {
            ...
            ////var data = baseCollectionItem.Data.SerializeToByteArray();
            SqlClient.Open();
            var query = @"update dbo.basecollectionitem set ItemProcessed=@ItemProcessed where Id=@Id;";
