...
namespace Appleseed.Base.Data.Queue
{
    ...
    public class BaseCollectionItemQueue : IBaseMessageQueue<BaseCollectionItem>
    {
        ...
        public BaseCollectionItemQueue(IRepository repository, ILog logger, string aggregationType = null, string incomingQueueName = null)
        {
            this.Log = logger;
        ...
        public void Enqueue(BaseCollectionItem item)
        {
            ...
            item.AggregationType = this._aggregationType;
